...
# 7. Fastfetch
# ------------------------------------------------------------------------------
section "Step 7/8" "Fastfetch lolcat figlet sl cmatrix"

exe pacman -S --noconfirm --needed fastfetch lolcat figlet sl cmatrix
success "Fastfetch lolcat figlet sl cmatrix installed."
